...
These are used to make the data available at runtime. Deploying the package can be accomplished in one of two ways.

1. [With The Framework Importer](WithoutFrameworkImporterHelp.md)
